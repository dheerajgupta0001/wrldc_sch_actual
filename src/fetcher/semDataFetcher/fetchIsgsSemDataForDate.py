...
def fetchIsgsSemSummaryForDate(semIsgsFolderPath: str, targetDt: dt.datetime, reName: str) -> List :
    ...
    if not os.path.isfile(targetFilePath):
        print("ISGS Sem file for date {0} is not present for state {1}".format(targetDt, reName))
        return [] 
